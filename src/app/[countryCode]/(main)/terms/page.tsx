    ...
    <div className="bg-white min-h-screen">
      ...
      <section className="py-12">
        <div className="content-container max-w-3xl prose prose-grey">
          ...
          <p className="text-grey-60 mb-4 leading-relaxed">These terms are governed by the laws of India. Any disputes shall be subject to the jurisdiction of courts in Coimbatore, Tamil Nadu, India.</p>
