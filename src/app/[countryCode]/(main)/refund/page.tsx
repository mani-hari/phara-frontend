    ...
    <div className="bg-white min-h-screen">
      ...
      <section className="py-12">
        <div className="content-container max-w-3xl prose prose-grey">
          ...
          <p className="text-grey-60 mb-4 leading-relaxed">If you cancel your order before the puja or homam has been performed, you are eligible for a full refund. Cancellation requests must be submitted via email (hello@pariharaonline.com) or WhatsApp (+91-97432 44501).</p>
          ...
          <p className="text-grey-60 mb-4 leading-relaxed">To request a refund or cancellation, contact us with your order number via: Email: hello@pariharaonline.com | WhatsApp: +91-97432 44501 | We aim to respond to all refund requests within 24 hours.</p>
